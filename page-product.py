...
# # membuat permintaan ke URL
# url = 'https://automotivesuperstore.com.au/autoss-csk-auda3-4100043k'
# r = requests.get(url)
...
# print(list_of_vehicle_compatibility.replace('Positions:,', 'Positions":"').replace('"": ', '').replace('Bay,Quantity', 'Bay","Quantity').replace('Quantity Per Vehicle:,', 'Quantity Per Vehicle":"'))
...
try:
    ...
    image_url = ''
try:
    price_wrapper = soup.find('span', {'class': 'price-wrapper'})
...
print('Saving', Automotivesuperstore['PartNumber'], Automotivesuperstore['Price'], Automotivesuperstore['List of Vehicle Compatibility'], Automotivesuperstore['Image URLs'])
